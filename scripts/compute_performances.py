...
#---------------------------------------Computation oF Confucion Matrix 2 for the threshold determined using 'kunitz_set_1.txt' as training and 'kunitz_set_2.txt' for Validation
    ...
    th1, cm1 = cross_validate(preds1, preds2, "Train1_Test2")
    
    # Esecuzione: Training su 2, Test su 1
    th2, cm2 = cross_validate(preds2, preds1, "Train2_Test1")
    cm2 = get_confusion_matrix(preds2,1e-5)
...
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    cm1 = get_confusion_matrix(preds1,1e-5) 